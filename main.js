...
let text = 'three.js',
  ...
  fontName = 'sans-serif', // helvetiker, optimer, gentilis, droid sans, droid serif
...
function loadFont() {
  ...
  loader.load('/fonts/' + fontName + '_' + fontWeight + '.typeface.json', function (response) {
      ...
      // If there's an error loading the specified font, fallback to a default font
      console.error('Error loading font:', error);
      console.log('Falling back to default font.');
      
      // Load your default font here
      loader.load('./fonts/default_font.typeface.json', function (defaultFont) {
          font = sans-serif;
          refreshText();
      });
  });
